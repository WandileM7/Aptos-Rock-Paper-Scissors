address 0x9a4213b5a1750d1a695a528b6d534c54baf43d814c2d9924115d842b66060243 {
...
module RockPaperScissors {
    ...
    public entry fun reset_for_new_game(account: &signer) acquires Game {
        let game = borrow_global_mut<Game>(signer::address_of(account));
        game.player_move = 0;
    ...
    #[view]
    public fun get_games_played(account_addr: address): u64 acquires Game {
        borrow_global<Game>(account_addr).games_played
    }
}
}